...
class Spice_Harvester:
    def __init__(self, collection_type, window, builder, onActivate=None):
        ...
        #self.builder.add_from_file(os.path.realpath(os.path.dirname(os.path.abspath(__file__)) + "/../applet-installer2.ui"))
        ...
        #self.spiceDetail = self.builder.get_object("spice_window")
        #self.spiceDetail = Gtk.Dialog()
    ...
    def refresh_cache(self, load_assets=True):
        ...
        self.load_cache()
        #print "Loaded index, now we know about %d applets." % len(self.index_cache)
